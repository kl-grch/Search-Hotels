    ...
    return (
        <div className="hotel">
            ...
            <div className="hotel__title">
                <div className="hotel__name">{props.name}</div>
                <div 
                className="hotel__favorite"
                >
                    <svg className='heart' width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="hotel__date">
                    <div className="hotel__date-date">{props.date}</div>
                    <span className='hotel__date-separator'></span>
                    <div className="hotel__date-day">{props.day} {setNameCount(props.day, 'дней', 'день', 'дня')}</div>
            </div>
            ...
            <div className="hotel__rate">
                ...
                <div className="hotel__rate-price">
                    ...
                    <div className="hotel__rate-price-price">{props.price} ₽</div>
                </div>
            </div>
        </div>
    )
